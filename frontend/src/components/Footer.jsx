...
function Footer() {
  return (
    <>
      ...
      <footer className="flex flex-col items-center justify-center w-full py-5 bg-gradient-to-b from-[#5524B7] to-[#380B60] text-white/70">
        <img src={Logov6NoBg} alt="" className="max-h-30" />
        <p className="mt-4 text-center">
          Merci d'avoir visité notre site ! Si vous avez des questions, des suggestions, n'hésitez pas à nous contacter. Nous sommes là pour vous aider et nous apprécions votre soutien continu. 
        </p>
